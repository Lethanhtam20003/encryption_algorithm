...
import org.example.controler.symmetricEncryptionController.BlowfishController;
...
public class Panel_Blowfish extends JPanel {
    ...
    private BlowfishController controller;

    public Panel_Blowfish(Frame frame) {
        model = new Blowfish();
        controller = new BlowfishController(this, model, frame);
        this.setLayout(new BorderLayout());
        JLabel title = new JLabel("Algorithm Blowfish", JLabel.CENTER);
...
// key information
        ...
        JComboBox<String> cbAlgorithmMode = new JComboBox<>(model.getListAlgorithms());
...
//        context panel
    ...
    public Blowfish getModel() {
        return model;
    }

    public void setModel(Blowfish model) {
        this.model = model;
    }

    public BlowfishController getController() {
        return controller;
    }

    public void setController(BlowfishController controller) {
