...
import org.example.controler.symmetricEncryptionController.SubstitutionController;
...
public class Panel_Substitution extends JPanel {
    private Substitution model;
    private SubstitutionController controller;
    ...
    public Panel_Substitution(JFrame frame) {
        model = new Substitution();
        controller = new SubstitutionController(this,model,frame);

        this.setLayout(new BorderLayout());
        JLabel title = new JLabel("Algorithm Substitution", JLabel.CENTER);
